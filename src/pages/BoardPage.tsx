    ...
    <div className="pt-28 pb-16 min-h-screen relative overflow-hidden bg-transparent text-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
                ...
                className="mb-4"
            >
                <p className="text-xs font-medium text-primary mb-2 uppercase tracking-wider">Leadership</p>
                <h1 className="text-3xl sm:text-5xl font-bold tracking-tight mb-3">Board Members</h1>
                <p className="text-muted-foreground max-w-lg">
                    The people driving MIC's mission and fostering a community of intellectual excellence.
                </p>
            </motion.div>
        </div>
        <BoardMembers />
